<x-app-layout>
    <section class="mt-6  w-[70%] m-auto   flex justify-between">
        ...
        <a href="{{ route ('category.edit', $category) }}" class="bg-green-600 transition duration-300 rounded-lg px-6 py-2
            hover:bg-green-400 text-center text-[14px] hover:underline text-white">
            Updated
        </a>
    </section>
